...
from typing import Any, Final, Literal, TypeVar, TypedDict, overload, type_check_only
from typing_extensions import TypeAlias

_IterableT = TypeVar("_IterableT", bound=Iterable[Any])
_T = TypeVar("_T")
_MultiDict: TypeAlias = Any
@type_check_only
...
ACL_ORIGIN: Final = ...
ACL_METHODS: Final = ...
ACL_ALLOW_HEADERS: Final = ...
ACL_EXPOSE_HEADERS: Final = ...
ACL_CREDENTIALS: Final = ...
ACL_MAX_AGE: Final = ...
ACL_RESPONSE_PRIVATE_NETWORK: Final = ...
ACL_REQUEST_METHOD: Final = ...
ACL_REQUEST_HEADERS: Final = ...
ACL_REQUEST_HEADER_PRIVATE_NETWORK: Final = ...
ALL_METHODS: Final[list[str]]
CONFIG_OPTIONS: Final[list[str]]
FLASK_CORS_EVALUATED: Final = ...
...
def try_match_any_pattern(inst: str, patterns: Iterable[str | Pattern[str]], caseSensitive: bool = ...) -> bool:
    ...

def try_match_pattern(value: str, pattern: str | Pattern[str], caseSensitive: bool = ...) -> bool | Match[str]:
    ...
